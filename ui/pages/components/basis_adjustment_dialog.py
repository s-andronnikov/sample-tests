...
class BasisAdjustmentDialog:
    """Basis adjustment dialog component for adding/editing basis adjustments"""
    ...
    def __init__(self, parent: BaseElement | None = None):
        ...
        self.adjustment_type_element = BaseElement(By.LOCATOR, "[name='adjustmentType'][role='combobox']", self.form_container)
        self.adjustment_type_select = BaseElement(By.LOCATOR, "i", self.adjustment_type_element)
        self.adjustment_type_options = BaseElement(By.LOCATOR, "[role='option']", self.adjustment_type_element)

        # Excluded Sets of Books selection
        self.excluded_books_element = BaseElement(By.LOCATOR, "[name='booksExcluded'][role='combobox']", self.form_container)
        self.excluded_books_select = BaseElement(By.LOCATOR, "i", self.excluded_books_element)
        self.excluded_books_options = BaseElement(By.LOCATOR, "[role='option']", self.excluded_books_element)
    ...
    def fill_form(self, name=None):
        """Fill the basis adjustment form
